...
function ProductsCurousel({
  ...
  return (
    <div className="ml-4">
      <Carousel dir="rtl">
        <CarouselContent className="sm:mx-10">
                ...
                <div className="p-1 group relative">
                  <Link href={`/products/${id}`}>
                    <Card className="my-8 transform group-hover:shadow-xl transition-shadow duration-300 md:h-80">
                      <CardContent>
                        <div className="relative h-32 sm:h-64 md:h-48 rounded mt-4">
                          <Image
                            src={firstImage}
                            alt={name}
                            fill
                        ...
                        <div className="mt-4 text-center">
                          <h2 className="text-xs sm:text-sm capitalize">
                            {name}
                          </h2>
          ...
          {featured && (
            <CarouselItem className="basis-1/3 lg:basis-1/4 flex justify-center items-center">
              <Link
                href="/featured"
